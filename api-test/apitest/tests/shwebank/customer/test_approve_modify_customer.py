...
hocifcd_update="old"
title_update="02"
title_of_organization_update="P"
suffix_update="SU"
firstname_update="frist name"
lastname_update="last name"
midname_update="mid name"
fullname_enterprise_update="FIRST LAST (fullname) enterprise test update"
fullname_individual_update="FIRST LAST (fullname) individual test update"
firstname_local_update="firstname local"
lastname_local_update="lastname local"
midname_local_update="midname local"
shortname_update="shortname update"
gender_update="01"
date_of_birth_update=datetime.fromisoformat("1998-02-25").strftime('%Y-%m-%dT%H:%M:%S')
place_of_birth_update="place_of_birth up"
nation_update="VN"
country_update="TH"
paper_type_update="I"
paper_number_enterprise_update="0731212"+ str(random_num)
paper_number_individual_update="0731312"+ str(random_num)
issue_date_of_paper_update=datetime.fromisoformat("2022-05-25").strftime('%Y-%m-%dT%H:%M:%S')
issue_place_of_paper_update="issue place of paper"
expire_date_of_paper_update=datetime.fromisoformat("2023-03-25").strftime('%Y-%m-%dT%H:%M:%S')
paper_type_sub_update="I"
paper_number_sub_update="psubup"
issue_date_of_sub_paper_update=datetime.fromisoformat("2024-06-25").strftime('%Y-%m-%dT%H:%M:%S')
issue_place_of_sub_paper_update="issue place sub update"
customer_group_type_update="P"
customer_sub_group_type_update="Q"
sector_update="BX"
subsector_update="BXA"
resident_update="N"
address_local_legal_update="a up"
province_legal_update="b up"
village_legal_update="v up"
sub_district_legal_update="c up"
district_legal_update="s up"
address_legal_update="e up"
zipcode_legal_update="w up"
address_local_contact_update="t up"
province_contact_update="r up"
village_contact_update="t up"
sub_district_contact_update="4 up"
district_contact_update="3 up"
address_contact_update="r up"
zipcode_contact_update="f up"
phone_home_update="phone up"
phone_mobile_update="ph up"
email_update="email@update.com"
education_update="E"
marital_status_update="S"
profession_update="P"
business_type_update="C"
financial_update="X"
isic_code_update="232E"
managing_branch_code_update="0999"
classify_update="W"
polists_update="P"
repolists_update="Q"
country_of_income_update="VN"
fatca_status_update="A"
government_id_update="E"
international_id_update="A"
oversea_juristic_id_update="W"
gfmis_code_update="E"
last_update_date_update=datetime.fromisoformat(working_date).strftime('%Y-%m-%dT%H:%M:%S')
group_id_update="234"
customer_credit_line_update=234000.54
currency_code_update="USD"
customer_type_update="Q"
primary_cif_update="F"
mdm_amount_status_update="GAS"
mdm_request_status_update="SAA"
mdm_list_sub_type_code_update="QDFF"
mdm_list_sub_type_desc_update="CXXZ"
mdm_matching_by_update="ED"
mdm_final_kyc_status_update="GV"
mdm_kyc_comment_code_update="VC"
mdm_kyc_comment_desc_update="WSS"
kyc_level_update="1"
kyc_update_date_update=datetime.fromisoformat(working_date).strftime('%Y-%m-%dT%H:%M:%S')
kyc_override_update="2X"
kyc_override_descr_update="FDWSS"
...
@pytest.mark.approve_modify_customer
class TestApproveModifyCustomer(object):


    @pytest.mark.simple_search_approve_modify_customer_before_modify
    def test_001_simple_search_approve_modify_customer_before_modify(self, user):
        global total_count
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.simple_search(
            page_size=5
        )
        rs = helper.SQL_SEARCH_APR(fields_data)
        try:
            ...
            if len(rs['items']) > 0:
                ...
                assert 'approve_status' in rs['items'][0], f'Key \"approve_status\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
    ...
    @pytest.mark.advanced_search_approve_modify_customer_before_modify
    def test_002_advanced_search_approve_modify_customer_before_modify(self, user):
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.advanced_search(
            page_size=5
        )
        rs = helper.SQL_ADSEARCH_APR(fields_data)
        try:
            assert 'total_count' in rs, f'Key \"total_count\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
    ...
    @pytest.mark.modify_customer_single_enterprise_first_time
    def test_004_modify_customer_single_enterprise_first_time(self, user):
        helper = CustomerSingleHelper(user)
        fields_data = customer_single_payload.update(
            id=id_enterprise_new,
            hocifcd=hocifcd_update,
            title=title_update,
            title_of_organization=title_of_organization_update,
            suffix=suffix_update,
            firstname=firstname_update,
            lastname=lastname_update,
            midname=midname_update,
            fullname=fullname_enterprise_update,
            firstname_local=firstname_local_update,
            lastname_local=lastname_local_update,
            midname_local=midname_local_update,
            shortname=shortname_update,
            gender=gender_update,
            date_of_birth=date_of_birth_update,
            place_of_birth=place_of_birth_update,
            nation=nation_update,
            country=country_update,
            paper_type=paper_type_update,
            paper_number=paper_number_enterprise_update,
            issue_date_of_paper=issue_date_of_paper_update,
            issue_place_of_paper=issue_place_of_paper_update,
            expire_date_of_paper=expire_date_of_paper_update,
            paper_type_sub=paper_type_sub_update,
            paper_number_sub=paper_number_sub_update,
            issue_date_of_sub_paper=issue_date_of_sub_paper_update,
            issue_place_of_sub_paper=issue_place_of_sub_paper_update,
            customer_group_type=customer_group_type_update,
            customer_sub_group_type=customer_sub_group_type_update,
            sector=sector_update,
            subsector=subsector_update,
            resident=resident_update,
            address_local_legal=address_local_legal_update,
            ...
            zipcode_legal=zipcode_legal_update,
            address_local_contact=address_local_contact_update,
            province_contact=province_contact_update,
            village_contact=village_contact_update,
            sub_district_contact=sub_district_contact_update,
            district_contact=district_contact_update,
            address_contact=address_contact_update,
            zipcode_contact=zipcode_contact_update,
            phone_home=phone_home_update,
            phone_mobile=phone_mobile_update,
            email=email_update,
            education=education_update,
            marital_status=marital_status_update,
            profession=profession_update,
            business_type=business_type_update,
            financial=financial_update,
            isic_code=isic_code_update,
            managing_branch_code=managing_branch_code_update,
            classify=classify_update,
            polists=polists_update,
            repolists=repolists_update,
            country_of_income=country_of_income_update,
            fatca_status=fatca_status_update,
            government_id=government_id_update,
            international_id=international_id_update,
            oversea_juristic_id=oversea_juristic_id_update,
            gfmis_code=gfmis_code_update,
            last_update_date=last_update_date_update,
            group_id=group_id_update,
            customer_credit_line=customer_credit_line_update,
            currency_code=currency_code_update,
            customer_type=customer_type_update,
            primary_cif=primary_cif_update,
            mdm_amount_status=mdm_amount_status_update,
            mdm_request_status=mdm_request_status_update,
            mdm_list_sub_type_code=mdm_list_sub_type_code_update,
            mdm_list_sub_type_desc=mdm_list_sub_type_desc_update,
            mdm_matching_by=mdm_matching_by_update,
            mdm_final_kyc_status=mdm_final_kyc_status_update,
            mdm_kyc_comment_code=mdm_kyc_comment_code_update,
            mdm_kyc_comment_desc=mdm_kyc_comment_desc_update,
            kyc_level=kyc_level_update,
            kyc_update_date=kyc_update_date_update,
            kyc_override=kyc_override_update,
            kyc_override_descr=kyc_override_descr_update
        )
        rs = helper.SQL_UPDATE_CTM(fields_data)
        try:
            # check key
            assert 'id' in rs, f'Key \"id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'customer_code' in rs, f'Key \"customer_code\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
    ...
    def test_005_add_customer_single_individual(self, user):
    ...
    @pytest.mark.modify_customer_single_individual_first_time
    def test_006_modify_customer_single_individual_first_time(self, user):
        helper = CustomerSingleHelper(user)
        fields_data = customer_single_payload.update(
            ...
            lastname=lastname_update,
            midname=midname_update,
            fullname=fullname_individual_update,
            firstname_local=firstname_local_update,
            lastname_local=lastname_local_update,
            midname_local=midname_local_update,
            shortname=shortname_update,
            ...
            country=country_update,
            paper_type=paper_type_update,
            paper_number=paper_number_individual_update,
            issue_date_of_paper=issue_date_of_paper_update,
            issue_place_of_paper=issue_place_of_paper_update,
            expire_date_of_paper=expire_date_of_paper_update,
            paper_type_sub=paper_type_sub_update,
    ...
    @pytest.mark.simple_search_approve_modify_customer_after_modify
    def test_007_simple_search_approve_modify_customer_after_modify(self, user):
        search_rs = False
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.simple_search(
            page_size=5,
    ...
    @pytest.mark.advanced_search_approve_modify_customer_after_modify
    def test_008_advanced_search_approve_modify_customer_after_modify(self, user):
        search_rs = False
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.advanced_search(
            page_size=50,
...
# view by customer code enterprise
    @pytest.mark.view_customer_single_enterprise_by_code
    def test_009_view_customer_single_enterprise_by_code(self, user):
        helper = ApproveModifyCustomerHelper(user)
        helper_single = CustomerSingleHelper(user)
        fields_data = customer_single_payload.view_by_customer_code(
            customer_code=customer_code_enterprise_new
        )
        rs = helper_single.SQL_VIEWBYCODE_CTM(fields_data)
        try:
            # check key
            assert 'id' in rs, f'Key \"id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'customer_code' in rs, f'Key \"customer_code\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            ...
            assert (total_count + 2) == rs['total_count'], f'Check total_count after view fail. Expected \'{total_count + 1}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
        except:
            assert False, f'Something\'s wrong. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'

# view by customer code individual
    @pytest.mark.view_customer_single_individual_by_code
    def test_010_view_customer_single_individual_by_code(self, user):
        helper = ApproveModifyCustomerHelper(user)
        helper_single = CustomerSingleHelper(user)
        fields_data = customer_single_payload.view_by_customer_code(
    ...
    @pytest.mark.simple_search_approve_modify_customer_check_page
    def test_011_simple_search_approve_modify_customer_check_page(self, user):
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.simple_search(
            page_size=2,
            page_index=1
    ...
    @pytest.mark.advanced_search_approve_modify_customer_check_page
    def test_012_advanced_search_approve_modify_customer_check_page(self, user):
        helper = ApproveModifyCustomerHelper(user)
        fields_data = approve_modify_customer_payload.advanced_search(
            page_size=2,
            page_index=1
...
# view user modify and reject modify customer enterprise
    @pytest.mark.view_user_modify_and_reject_modify_customer_single_enterprise
    def test_013_view_user_modify_and_reject_modify_customer_single_enterprise(self, user):
        try:
            # view user modify
            global tx_reference_id_enterprise_new
            tx_reference_id_enterprise_new = ''
            helper = ApproveModifyCustomerHelper(user)
            fields_data = approve_modify_customer_payload.view_user_modify_customer(
                customer_code=customer_code_enterprise_new
            )
            rs = helper.CTM_GET_INFO_USER_MODIFY(fields_data)
            assert 'user_name' in rs, f'Key \"user_name\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'tx_reference_id' in rs, f'Key \"tx_reference_id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'notification' in rs, f'Key \"notification\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'is_approve' in rs, f'Key \"is_approve\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'trans_date' in rs, f'Key \"trans_date\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            tx_reference_id_enterprise_new = rs['tx_reference_id']
            # SQL_VIEW_APR view modify
            fields_data = approve_modify_customer_payload.view_info_modify_customer(
                transaction_id=tx_reference_id_enterprise_new,
                customer_code=customer_code_enterprise_new
            )
            rs = helper.SQL_VIEW_APR(fields_data)
            # check key
            assert 'hocifcd' in rs, f'Key \"hocifcd\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'title' in rs, f'Key \"title\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'title_of_organization' in rs, f'Key \"title_of_organization\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            ...
            # assert 'kyc_override' in rs, f'Key \"kyc_override\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # assert 'kyc_override_descr' in rs, f'Key \"kyc_override_descr\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # assert 'reference_id' in rs, f'Key \"reference_id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # assert 'transaction_date' in rs, f'Key \"transaction_date\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # assert 'approve_status' in rs, f'Key \"approve_status\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # assert 'customer_code' in rs, f'Key \"customer_code\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # check value
            # assert customer_code_enterprise_new == rs['customer_code'], f'Expected \'{customer_code_enterprise_new}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # ???? check value modify here
            # reject modify
            fields_data = approve_modify_customer_payload.reject_info_modify_customer(
                transaction_id=tx_reference_id_enterprise_new,
                customer_code=customer_code_enterprise_new
            )
            rs = helper.SQL_CTM_REJ(fields_data)
            # check key
            assert 'customer_code' in rs, f'Key \"customer_code\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'transaction_id' in rs, f'Key \"transaction_id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # check value
            assert customer_code_enterprise_new == rs['customer_code'], f'Expected \'{customer_code_enterprise_new}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert tx_reference_id_enterprise_new == rs['transaction_id'], f'Expected \'{tx_reference_id_enterprise_new}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
        except:
            assert False, f'Something\'s wrong. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'


# view user modify and reject modify customer individual
    @pytest.mark.view_user_modify_and_reject_modify_customer_single_individual
    def test_014_view_user_modify_and_reject_modify_customer_single_individual(self, user):
        try:
            # view user modify
            global tx_reference_id_individual_new
            tx_reference_id_individual_new = ''
            helper = ApproveModifyCustomerHelper(user)
            fields_data = approve_modify_customer_payload.view_user_modify_customer(
                customer_code=customer_code_individual_new
            )
            ...
            assert 'is_approve' in rs, f'Key \"is_approve\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'trans_date' in rs, f'Key \"trans_date\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            tx_reference_id_individual_new = rs['tx_reference_id']
            # SQL_VIEW_APR view modify
            fields_data = approve_modify_customer_payload.view_info_modify_customer(
                transaction_id=tx_reference_id_individual_new,
                customer_code=customer_code_individual_new
            )
            rs = helper.SQL_VIEW_APR(fields_data)
            # check key
            ...
            # check value
            assert customer_code_individual_new == rs['customer_code'], f'Expected \'{customer_code_individual_new}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert tx_reference_id_individual_new == rs['transaction_id'], f'Expected \'{tx_reference_id_individual_new}\', Actual response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
        except:
            assert False, f'Something\'s wrong. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'


# modify second time
    @pytest.mark.modify_customer_single_enterprise_second_time
    def test_015_modify_customer_single_enterprise_second_time(self, user):
        helper = CustomerSingleHelper(user)
        fields_data = customer_single_payload.update(
            id=id_enterprise_new,
            hocifcd=hocifcd_update,
    ...
    @pytest.mark.modify_customer_single_individual_second_time
    def test_016_modify_customer_single_individual_second_time(self, user):
        helper = CustomerSingleHelper(user)
        fields_data = customer_single_payload.update(
            id=id_individual_new,
            hocifcd=hocifcd_update,
...
# view user modify and approve modify customer enterprise
    @pytest.mark.view_user_modify_and_approve_modify_customer_single_enterprise
    def test_017_view_user_modify_and_approve_modify_customer_single_enterprise(self, user):
        try:
            # view user modify
            global tx_reference_id_enterprise_new
            tx_reference_id_enterprise_new = ''
            ...
            rs = helper.SQL_CTM_APR(fields_data)
            # check key
            assert 'customer_code' in rs, f'Key \"customer_code\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            assert 'transaction_id' in rs, f'Key \"transaction_id\" does not exist. Response Json: {json.dumps(rs, indent=4, sort_keys=True)}'
            # check value
...
# view user modify and approve modify customer individual
    @pytest.mark.view_user_modify_and_approve_modify_customer_single_individual
    def test_018_view_user_modify_and_approve_modify_customer_single_individual(self, user):
        try:
            # view user modify
            global tx_reference_id_individual_new
            tx_reference_id_individual_new = ''
...
# delete data
    ...
    def test_019_delete_customer_single_enterprise(self, user):
        helper = CustomerSingleHelper(user)
        helper_group = CustomerGroupHelper(user)
    ...
    def test_020_delete_customer_single_individual(self, user):
        helper = CustomerSingleHelper(user)
        fields_data = customer_single_payload.delete(
            id=id_individual_new
        )
