...
credit_rate=1.0
debit_amount=500.0
credit_amount=11700000.0
base_amount=11700000.0
fee_amount=250.0
receive_amount=11699750.0
# data test invalid
...
@pytest.mark.SP_ACT_CSH
class Test_SP_ACT_CSH(object):

    def test_sp_act_csh_001_success(self, user):
        ...
        fields_data = sp_payload.ACT_CSH(
        ...
        rs = sp_helper.ACT_CSH(fields_data)
        step_code = 'ACT_CSH'
