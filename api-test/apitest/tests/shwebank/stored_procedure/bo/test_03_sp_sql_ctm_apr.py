...
# data test valid
transaction_id='1bd701aa81264e2696b49ea03db59c86'
...
@pytest.mark.SP_SQL_CTM_APR
class Test_SP_SQL_CTM_APR(object):

    def test_sp_sql_ctm_apr_001_success(self, user):
        sp_helper = StoredProcedureHelper(user)
        fields_data = sp_payload.SQL_CTM_APR(
            transaction_id=transaction_id,
            customer_code=customer_code
        )
        rs = sp_helper.SQL_CTM_APR(fields_data)
        step_code = 'CTM_APPROVE_MODIFY'
