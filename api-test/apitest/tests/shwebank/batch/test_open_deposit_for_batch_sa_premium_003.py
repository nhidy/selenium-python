...
account_name_saving_deposit='test batch premium call deposit 003'
...
@pytest.mark.open_deposit_for_batch_premium_savings_003
class TestOpenDepositForBatchSAPremium003(object):

    @pytest.mark.open_deposit_premium_savings_003
    def test_003_open_deposit_premium_savings_003(self, user):
