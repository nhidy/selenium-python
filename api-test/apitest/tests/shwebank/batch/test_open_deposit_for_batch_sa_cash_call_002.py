...
account_name_saving_deposit='test batch cash call deposit 002'
...
@pytest.mark.open_deposit_for_batch_cash_call_002
class TestOpenDepositForBatchSACashCall002(object):

    @pytest.mark.open_deposit_cash_call_002
    def test_002_open_deposit_cash_call_002(self, user):
