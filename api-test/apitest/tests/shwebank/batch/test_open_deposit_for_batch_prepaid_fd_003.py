...
account_name_saving_deposit='test batch account linkage for prepaid FD by transfer 003'
...
account_name_prepaid_fd_transfer='test batch prepaid FD by transfer 003'
...
amount_deposit_saving=700000000
exchange_rate=1
deposit_type_cash_current='C'
description_dpt_cdp='1110: Cash deposit'

# data transfer fixed
amount_deposit_fixed=400000000.00
exchange_rate=1
...
class TestOpenDepositAccountForBatch(object):
    ...
    def test_003_open_deposit_account_prepaid_fd_003(self, user):
        ...
        fields_data = deposit_fo_payload.dpt_cdp(
            ...
            amount=amount_deposit_saving,
            currency_deposit=currency_code_mmk,
            values_date=working_date,
            customer_code=customer_code,
            cash_amount_bcy=amount_deposit_saving,
            cash_exchange_rate=exchange_rate,
            cash_amount=amount_deposit_saving,
        ...
        try:
            ...
            data_actual = RequestUtility.get_p2_content_response_by_step_code(rs, step_code)
            print(json.dumps(data_actual, indent=4, sort_keys=False))
            account_number_new_prepaid_fd_transfer = data_actual['data']['account_number']
            transaction_number = data_actual['data']['transaction_number']
