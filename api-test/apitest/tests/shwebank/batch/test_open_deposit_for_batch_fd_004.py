...
account_name_current_deposit='test batch account linkage for FD status Block ' + str(random_num)
rollover_current_deposit='N'
auto_transfer_option_current_deposit='N'
# data open fixed deposit
catalog_code_fixed_3m_deposit='FD03POMMK'
catalog_name_fixed_3m_deposit='Fixed deposit 3 months (Principal rollover only) in MMK'
...
account_name_fixed_3m_deposit='test batch FD 3M ' + str(random_num) + ' - invalid linkage'
rollover_fixed_3m_deposit='P'
auto_transfer_option_fixed_3m_deposit='I'
...
class TestOpenDepositAccountForBatch(object):
    ...
    def test_004_open_deposit_account_fd_004(self, user):
        ...
        # block current deposit account
        fields_data = deposit_fo_payload.dpt_blk(
            account_number=account_number_new_current_deposit,
            depositor_name=account_name_current_deposit,
            depositor_id=customer_code,
            depositor_balance=amount_deposit_current,
        ...
        global account_number_new_fixed_3m_deposit
        account_number_new_fixed_3m_deposit = ''
        fields_data = deposit_fo_payload.dpt_opn(
            customer_type=customer_type,
            customer_code=customer_code,
        ...
        try:
            ...
            data_actual = RequestUtility.get_p2_content_response_by_step_code(rs, step_code)
            print(json.dumps(data_actual, indent=4, sort_keys=False))
            account_number_new_fixed_3m_deposit = data_actual['data']['account_number']
            transaction_number = data_actual['data']['transaction_number']
        ...
        fields_data = deposit_fo_payload.dpt_apr(
            account_number=account_number_new_fixed_3m_deposit,
