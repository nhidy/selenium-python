...
account_name_saving_deposit='test batch premium call deposit 001'
...
@pytest.mark.open_deposit_for_batch_premium_savings_001
class TestOpenDepositForBatchSAPremium001(object):

    @pytest.mark.open_deposit_premium_savings_001
    def test_001_open_deposit_premium_savings_001(self, user):
