...
account_name_current_deposit='test batch account linkage for prepaid FD by cash 001'
...
account_name_prepaid_fd_cash='test batch prepaid FD by cash 001'
...
amount_deposit_fixed=1000000000.00
exchange_rate=1
