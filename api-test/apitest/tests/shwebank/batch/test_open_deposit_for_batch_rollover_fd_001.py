...
account_name_current_deposit='test batch account linkage for FD - linkage Normal ' + str(random_num)
rollover_current_deposit='N'
auto_transfer_option_current_deposit='N'
# data open fixed deposit
deposit_sub_type_fixed_3m_deposit='T1'
...
catalog_code_fixed_3m_deposit_nr='FD01NRMMK'
catalog_name_fixed_3m_deposit_nr='Fixed deposit 1 months (No rollover) in MMK'
account_name_fixed_3m_deposit_nr='test rollover FD (NR) - linkage Normal ' + str(random_num)
rollover_fixed_3m_deposit_nr='N'
auto_transfer_option_fixed_3m_deposit_nr='A'
# data open fixed deposit (principal only)
catalog_code_fixed_3m_deposit_po='FD01POMMK'
catalog_name_fixed_3m_deposit_po='Fixed deposit 1 months (Principal rollover only) in MMK'
account_name_fixed_3m_deposit_po='test rollover FD (PO) - linkage Normal ' + str(random_num)
rollover_fixed_3m_deposit_po='P'
auto_transfer_option_fixed_3m_deposit_po='I'
# data open fixed deposit (principal + interest)
catalog_code_fixed_3m_deposit_pi='FD01PIMMK'
catalog_name_fixed_3m_deposit_pi='Fixed deposit 1 months (Principal plus interest rollover) in MMKS'
account_name_fixed_3m_deposit_pi='test rollover FD (PI) - linkage Normal ' + str(random_num)
...
class TestOpenDepositAccountForBatch(object):
    ...
    def test_007_open_deposit_account_fd_007(self, user):
        ...
        account_number_new_current_deposit = '110054829228'
