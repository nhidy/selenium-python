...
account_name_saving_deposit='test batch call deposit 004'
...
@pytest.mark.open_deposit_for_batch_call_savings_004
class TestOpenDepositForBatchSACall004(object):

    @pytest.mark.open_deposit_call_savings_004
    def test_004_open_deposit_call_savings_004(self, user):
