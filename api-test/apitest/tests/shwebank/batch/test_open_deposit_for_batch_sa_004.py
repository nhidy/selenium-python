...
account_name_saving_deposit='test batch savings 004'
...
@pytest.mark.open_deposit_for_batch_savings_004
class TestOpenDepositForBatchSA004(object):

    @pytest.mark.open_deposit_savings_004
    def test_001_open_deposit_savings_004(self, user):
