...
account_name_saving_deposit='test batch call deposit 002'
...
@pytest.mark.open_deposit_for_batch_call_savings_002
class TestOpenDepositForBatchSACall002(object):

    @pytest.mark.open_deposit_call_savings_002
    def test_002_open_deposit_call_savings_002(self, user):
