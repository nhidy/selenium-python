...
catalog_code_saving_deposit='CDMMK0000'
catalog_name_saving_deposit='Call deposit account in MMK'
deposit_type_saving_deposit='Savings'
deposit_sub_type_saving_deposit='S4'
deposit_purpose_saving_deposit='P'
account_type_saving_deposit='1'
account_name_saving_deposit='test batch call deposit 001'
...
@pytest.mark.open_deposit_for_batch_call_savings_001
class TestOpenDepositForBatchSACall001(object):

    @pytest.mark.open_deposit_call_savings_001
    def test_001_open_deposit_call_savings_001(self, user):
