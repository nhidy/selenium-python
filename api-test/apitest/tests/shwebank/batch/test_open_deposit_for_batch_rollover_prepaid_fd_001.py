...
account_name_current_deposit='test batch account linkage for prepaid FD - linkage Normal ' + str(random_num)
...
account_name_prepaid_fd_nr='prepaid FD (NR) - linkage Normal ' + str(random_num)
...
account_name_prepaid_fd_po='prepaid FD (PO) - linkage Normal ' + str(random_num)
...
amount_deposit_fixed=1500000.00
exchange_rate=1
