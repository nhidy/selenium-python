...
catalog_code_saving_deposit='SCMMK0000'
catalog_name_saving_deposit='SHWE cash call deposit account in MMK'
deposit_type_saving_deposit='Savings'
deposit_sub_type_saving_deposit='S6'
deposit_purpose_saving_deposit='P'
account_type_saving_deposit='1'
account_name_saving_deposit='test batch cash call deposit 001'
...
@pytest.mark.open_deposit_for_batch_cash_call_001
class TestOpenDepositForBatchSACashCall001(object):

    @pytest.mark.open_deposit_cash_call_001
    def test_001_open_deposit_cash_call_001(self, user):
