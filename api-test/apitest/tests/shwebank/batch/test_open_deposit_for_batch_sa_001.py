...
account_name_saving_deposit='test batch savings 001'
...
@pytest.mark.open_deposit_for_batch_savings_001
class TestOpenDepositForBatchSA001(object):

    @pytest.mark.open_deposit_savings_001
    def test_001_open_deposit_savings_001(self, user):
