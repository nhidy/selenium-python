...
account_name_saving_deposit='test batch savings 002'
...
@pytest.mark.open_deposit_for_batch_savings_002
class TestOpenDepositForBatchSA002(object):

    @pytest.mark.open_deposit_savings_002
    def test_001_open_deposit_savings_002(self, user):
