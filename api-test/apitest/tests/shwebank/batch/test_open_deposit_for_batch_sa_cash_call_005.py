...
account_name_saving_deposit='test batch cash call deposit 005'
...
@pytest.mark.open_deposit_for_batch_cash_call_005
class TestOpenDepositForBatchSACashCall005(object):

    @pytest.mark.open_deposit_cash_call_005
    def test_005_open_deposit_cash_call_005(self, user):
