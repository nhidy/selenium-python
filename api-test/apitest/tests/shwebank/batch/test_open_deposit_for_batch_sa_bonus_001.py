...
account_name_saving_deposit='test batch bonus savings 001'
...
@pytest.mark.open_deposit_for_batch_bonus_savings_001
class TestOpenDepositForBatchSABonus001(object):

    @pytest.mark.open_deposit_bonus_savings_001
    def test_001_open_deposit_bonus_savings_001(self, user):
