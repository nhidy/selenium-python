...
catalog_code_saving_deposit='PSMMK0000'
catalog_name_saving_deposit='Premier savings deposit account in MMK'
deposit_type_saving_deposit='Savings'
deposit_sub_type_saving_deposit='S3'
deposit_purpose_saving_deposit='P'
account_type_saving_deposit='1'
account_name_saving_deposit='test batch premier savings 001'
...
@pytest.mark.open_deposit_for_batch_premier_savings_001
class TestOpenDepositForBatchSAPremier001(object):

    @pytest.mark.open_deposit_premier_savings_001
    def test_001_open_deposit_premier_savings_001(self, user):
