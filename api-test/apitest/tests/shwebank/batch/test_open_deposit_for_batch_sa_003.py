...
account_name_saving_deposit='test batch savings 003'
...
@pytest.mark.open_deposit_for_batch_savings_003
class TestOpenDepositForBatchSA003(object):

    @pytest.mark.open_deposit_savings_003
    def test_001_open_deposit_savings_003(self, user):
