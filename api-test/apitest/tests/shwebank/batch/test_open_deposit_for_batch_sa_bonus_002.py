...
account_name_saving_deposit='test batch bonus savings 002'
...
@pytest.mark.open_deposit_for_batch_bonus_savings_002
class TestOpenDepositForBatchSABonus002(object):

    @pytest.mark.open_deposit_bonus_savings_002
    def test_001_open_deposit_bonus_savings_002(self, user):
