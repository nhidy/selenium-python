...
account_name_saving_deposit='test batch call deposit 003'
...
@pytest.mark.open_deposit_for_batch_call_savings_003
class TestOpenDepositForBatchSACall003(object):

    @pytest.mark.open_deposit_call_savings_003
    def test_003_open_deposit_call_savings_003(self, user):
