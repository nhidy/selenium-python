...
account_name_saving_deposit='test batch premium call deposit 002'
...
@pytest.mark.open_deposit_for_batch_premium_savings_002
class TestOpenDepositForBatchSAPremium002(object):

    @pytest.mark.open_deposit_premium_savings_002
    def test_002_open_deposit_premium_savings_002(self, user):
