...
account_name_saving_deposit='test batch call deposit 005'
...
@pytest.mark.open_deposit_for_batch_call_savings_005
class TestOpenDepositForBatchSACall005(object):

    @pytest.mark.open_deposit_call_savings_005
    def test_005_open_deposit_call_savings_005(self, user):
