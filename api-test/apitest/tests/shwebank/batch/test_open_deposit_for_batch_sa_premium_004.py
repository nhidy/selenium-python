...
account_name_saving_deposit='test batch premium call deposit 004'
...
@pytest.mark.open_deposit_for_batch_premium_savings_004
class TestOpenDepositForBatchSAPremium004(object):

    @pytest.mark.open_deposit_premium_savings_004
    def test_004_open_deposit_premium_savings_004(self, user):
