...
account_name_saving_deposit='test batch cash call deposit 003'
...
@pytest.mark.open_deposit_for_batch_cash_call_003
class TestOpenDepositForBatchSACashCall003(object):

    @pytest.mark.open_deposit_cash_call_003
    def test_003_open_deposit_cash_call_003(self, user):
