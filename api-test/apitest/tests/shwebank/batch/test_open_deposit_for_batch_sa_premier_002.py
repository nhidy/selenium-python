...
account_name_saving_deposit='test batch premier savings 002'
...
@pytest.mark.open_deposit_for_batch_premier_savings_002
class TestOpenDepositForBatchSAPremier002(object):

    @pytest.mark.open_deposit_premier_savings_002
    def test_001_open_deposit_premier_savings_002(self, user):
