...
catalog_code_fixed_3m_deposit='FD03PIMMK'
catalog_name_fixed_3m_deposit='Fixed deposit 3 months (Principal plus interest rollover) in MMKS'
...
account_name_fixed_3m_deposit='test batch FD 3M ' + str(random_num)
rollover_fixed_3m_deposit='A'
auto_transfer_option_fixed_3m_deposit='N'
...
class TestOpenDepositAccountForBatch(object):
    ...
    def test_005_open_deposit_account_fd_005(self, user):
