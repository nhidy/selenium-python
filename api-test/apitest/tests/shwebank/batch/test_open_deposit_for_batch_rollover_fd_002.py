...
account_name_current_deposit='test batch account linkage for FD - linkage Block ' + str(random_num)
...
account_name_fixed_3m_deposit_nr='test rollover FD (NR) - linkage Block ' + str(random_num)
...
account_name_fixed_3m_deposit_po='test rollover FD (PO) - linkage Block ' + str(random_num)
...
catalog_name_fixed_3m_deposit_pi='Fixed deposit 3 months (Principal plus interest rollover) in MMKS'
account_name_fixed_3m_deposit_pi='test rollover FD (PI) - linkage Block ' + str(random_num)
