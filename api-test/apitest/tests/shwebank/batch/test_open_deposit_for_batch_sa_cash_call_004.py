...
account_name_saving_deposit='test batch cash call deposit 004'
...
@pytest.mark.open_deposit_for_batch_cash_call_004
class TestOpenDepositForBatchSACashCall004(object):

    @pytest.mark.open_deposit_cash_call_004
    def test_004_open_deposit_cash_call_004(self, user):
