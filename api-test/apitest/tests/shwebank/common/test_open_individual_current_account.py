...
deposit_type_current_deposit='Currents'
deposit_purpose_current_deposit='P'
account_type_current_deposit='1'
account_name_current_deposit='TEST AUTO CURRENT '
...
amount_deposit_current=1000.00
exchange_rate=1
...
@pytest.mark.open_individual_current_account
class TestOpenIndividualCurrentAccount(object):
