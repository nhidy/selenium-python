...
# data not change
value_catalogue_code = 'AUTO00004'
value_currency_code = 'MMK'
value_deposit_type = 'Fixed Deposit'
value_deposit_sub_type = 'Shwe Prepaid Fixed Deposit Account'
value_deposit_purpose = 'Savings'
value_deposit_classification = 'Normal Deposit'
value_passbook_or_statement_or_receipt = 'FD-receipt'
...
value_rollover_to_catalogue = 'PR007MMK1'
value_initial_deposit_amount = '100,000.00'
value_ifc_codes = ['Prepaid Fixed Deposit (7 days)']
value_expected_ifc_list_codes = ['152']
value_expected_ifc_names = value_ifc_codes
value_expected_ifc_values = ['8.50000']
value_expected_ifc_types = ['Interest']
value_expected_ifc_tenors = ['1']
value_expected_ifc_tenor_units = ['Year(s)']
value_expected_ifc_statuses = ['Normal']
value_expected_gls_sys_account_names = ['DEPOSIT']
value_expected_gls_account_aliass = ['###{REF}**']
value_expected_extension_sys_account_names = ['DEPOSIT', 'DEPOSIT']
value_expected_extension_replace_bys = ['2020302031111', '2020102020505']
value_business_lines = ['Personal', 'Corporate']
...
class DepositCataloguePrepaidTest(FormAction):
    def get_url(self):
        return RUN_ON_URL
...
# DPT-Catalogue Definition
    def test_001_dpt_cat_prepaid_add(self):
    ...
    def test_002_dpt_cat_prepaid_add_verify(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # verify data add
    ...
    def test_003_dpt_cat_prepaid_add_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # approve data add
    ...
    def test_004_dpt_cat_prepaid_view_after_add(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_006_dpt_cat_prepaid_update(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_007_dpt_cat_prepaid_update_verify(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # verify data update
    ...
    def test_008_dpt_cat_prepaid_update_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # approve data update
        self.bo_approval_approve(
            transaction_number=transaction_number_update,
    ...
    def test_009_dpt_cat_prepaid_view_after_update(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        self.deposit_catalogue_definition_view(
    ...
    def test_010_dpt_cat_prepaid_delete_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_011_dpt_cat_prepaid_after_delete(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
