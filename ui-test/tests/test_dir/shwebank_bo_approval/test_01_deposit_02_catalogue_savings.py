...
# data not change
value_catalogue_code = 'AUTO00002'
value_currency_code = 'MMK'
value_deposit_type = 'Savings'
value_deposit_sub_type = 'Premium Call Deposit Account'
value_deposit_purpose = 'Payment'
...
value_debit_accounting = False
value_debit_cash = False
value_debit_deposit = True
value_credit_accounting = True
value_credit_cash = True
value_credit_deposit = False
value_tenor_1 = '0'
...
value_credit_interest_y_n = 'Yes'
value_credit_interest_tenor = '1'
value_credit_interest_tenor_unit = 'Day(s)'
value_the_day_of_tenor_for_crediting_interest = '1'
...
value_ifc_codes = ['Premium call deposit account (EOD balance 10,000 to 199,999,999) in MMK', 'Premium call deposit account (EOD balance 200,000,000 to 499,999,999) in MMK', 'Premium call deposit account (EOD balance 500,000,000 and above) in MMK']
value_expected_ifc_list_codes = ['107', '108', '109']
value_expected_ifc_names = value_ifc_codes
value_expected_ifc_values = ['6.00000', '7.00000', '8.00000']
value_expected_ifc_types = ['Interest', 'Interest', 'Interest']
...
class DepositCatalogueSavingsTest(FormAction):
    def get_url(self):
        return RUN_ON_URL
...
# DPT-Catalogue Definition
    def test_001_dpt_cat_savings_add(self):
    ...
    def test_002_dpt_cat_savings_add_verify(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # verify data add
    ...
    def test_003_dpt_cat_savings_add_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # approve data add
    ...
    def test_004_dpt_cat_savings_view_after_add(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_006_dpt_cat_savings_update(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_007_dpt_cat_savings_update_verify(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # verify data update
    ...
    def test_008_dpt_cat_savings_update_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        # approve data update
        self.bo_approval_approve(
            transaction_number=transaction_number_update,
    ...
    def test_009_dpt_cat_savings_view_after_update(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
        self.deposit_catalogue_definition_view(
    ...
    def test_010_dpt_cat_savings_delete_approve(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
    ...
    def test_011_dpt_cat_savings_after_delete(self):
        print('Start: ' + datetime.now().strftime('%d/%m/%Y %H:%M:%S'))
