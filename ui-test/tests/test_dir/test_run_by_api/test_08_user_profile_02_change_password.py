...
USER_CODE_MANAGER = os.getenv("USER_CODE_MANAGER", "")
PASSWORD_MANAGER = os.getenv("PASSWORD_MANAGER", "")
USER_CODE_TELLER = os.getenv("USER_CODE_TELLER", "")
PASSWORD_TELLER = os.getenv("PASSWORD_TELLER", "")
# data required
# user_name_test = None
...
class UserProfileChangePasswordTest(FormAction):
    def get_url(self):
        return RUN_ON_URL
