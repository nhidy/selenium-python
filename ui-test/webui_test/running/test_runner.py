...
def main(path=None, browser=None, report=None, title="WebUI Test Report", description="WEBUI Test Case Execution", debug=False, rerun=0, save_last_run=False, timeout=10, xmlrunner=False, headless=False):
