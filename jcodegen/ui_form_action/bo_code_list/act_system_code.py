...
def system_code_table_view(self, code_id=None, code_name=None, caption_of_code=None, english=None, vietnamese=None, laothian=None, khmer=None, myanmar=None, code_of_group=None, code_index=None, code_value=None, field_link=None, is_visible=None):
    # search
...
def system_code_table_update(self, code_id=None, code_name=None, caption_of_code=None, english=None, vietnamese=None, laothian=None, khmer=None, myanmar=None, code_of_group=None, code_index=None, code_value=None, field_link=None, is_visible=None, list_error_message=None):
    # view
...
def system_code_table_view_update_verify(self, transaction_number, code_id=None, code_name=None, caption_of_code=None, english=None, vietnamese=None, laothian=None, khmer=None, myanmar=None, code_of_group=None, code_index=None, code_value=None, field_link=None, is_visible=None):
    # open form
...
def test_000_system_code_table_update_success(self):
    ...
    code_id_out=system_code_table_update_result[0]
    code_name_out=system_code_table_update_result[1]
    code_of_group_out=system_code_table_update_result[2]
